...
//  * Предгруппировывать лист отдельной утилитой, а автоопределение выключить
//  * Добавить возможность изменить "направление" опроса eng-dutch and vice versa
//  * Добавить веса, прописывать в жсонине. Если ошибаешься - увеличивать вес, при достаточном количестве правильных ответов - уменьшать (Но не сразу до нормы)
//  ** Возможность просить напечатать ответ (требуется нормализация списка)
//  * Добавление новых слов
//  * Открывать вопрос двойным щелчком по трею
